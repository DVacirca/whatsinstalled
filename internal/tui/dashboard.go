...
// buildTabs rebuilds tab labels from the currently loaded counts. "All" is
// always first; the remaining source tabs follow in alphabetical order. A
// STABLE order matters because `m.tabIndex` is positional — iterating the
